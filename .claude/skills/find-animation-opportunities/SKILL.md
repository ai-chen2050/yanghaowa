...
> **来源**：第三方技能包 [emilkowalski/skills](https://github.com/emilkowalski/skills)（MIT），逐字拷贝。
> 原则通用，但代码示例是 CSS/JS —— Flutter / Godot 里的对应写法见
> [`../THIRD-PARTY-NOTICES.md`](../THIRD-PARTY-NOTICES.md) 的「适配对照」。
